...
namespace FinalProject.Controllers
{
    public class OrderProesController : Controller
    {
        ...
        {
            ViewBag.IDCus = new SelectList(db.Customers, "IDCus", "IDCus");
        ...
        public ActionResult Create([Bind(Include = "ID,DateOrder,IDPro,IDCus")] OrderPro orderPro)
        {
            ...
            ViewBag.IDCus = new SelectList(db.Customers, "IDCus", "IDCus", orderPro.IDCus);
            return View(orderPro);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,DateOrder,IDPro,IDCus")] OrderPro orderPro)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult DeleteConfirmed(int id)
        {
            ...
            // Xóa các bản ghi OrderDetails liên quan trước
            var orderDetails = db.OrderDetails.Where(od => od.IDOrder == id);
            db.OrderDetails.RemoveRange(orderDetails);

            // Xóa đơn hàng sau khi đã xóa các bản ghi liên quan
